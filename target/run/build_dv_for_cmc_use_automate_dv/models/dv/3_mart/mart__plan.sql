    ...
    EXEC('create view "dbo"."mart__plan__dbt_tmp_temp_view" as select 
...
HAVING SUM(H.TotalBeforeVAT) > 1000;');
   ...
   EXEC('CREATE TABLE "dbo"."mart__plan__dbt_tmp" AS (SELECT * FROM "dbo"."mart__plan__dbt_tmp_temp_view");');
    ...
    EXEC('DROP view IF EXISTS "dbo"."mart__plan__dbt_tmp_temp_view";');
