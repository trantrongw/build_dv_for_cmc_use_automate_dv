    ...
    EXEC('create view "dbo"."mart__opportunity__dbt_tmp_temp_view" as select 
...
inner join "DWH"."dbo"."dv__h_opportunity" D ON D.dv_hash_key_h_opportunity = C.dv_master_hash_key_h_opportunity;');
   ...
   EXEC('CREATE TABLE "dbo"."mart__opportunity__dbt_tmp" AS (SELECT * FROM "dbo"."mart__opportunity__dbt_tmp_temp_view");');
    ...
    EXEC('DROP view IF EXISTS "dbo"."mart__opportunity__dbt_tmp_temp_view";');
