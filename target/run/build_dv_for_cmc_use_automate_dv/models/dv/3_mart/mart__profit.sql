    ...
    EXEC('create view "dbo"."mart__profit__dbt_tmp_temp_view" as select 
...
D.dv_hash_key_h_opportunity
   ...
   EXEC('CREATE TABLE "dbo"."mart__profit__dbt_tmp" AS (SELECT * FROM "dbo"."mart__profit__dbt_tmp_temp_view");');
    ...
    EXEC('DROP view IF EXISTS "dbo"."mart__profit__dbt_tmp_temp_view";');
