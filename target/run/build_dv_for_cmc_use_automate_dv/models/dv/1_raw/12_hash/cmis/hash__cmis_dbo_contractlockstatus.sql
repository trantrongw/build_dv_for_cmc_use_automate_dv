    ...
    EXEC('create view "dbo"."hash__cmis_dbo_contractlockstatus__dbt_tmp_temp_view" as 
...
SELECT * FROM columns_to_select;');
   ...
   EXEC('CREATE TABLE "dbo"."hash__cmis_dbo_contractlockstatus__dbt_tmp" AS (SELECT * FROM "dbo"."hash__cmis_dbo_contractlockstatus__dbt_tmp_temp_view");');
    ...
    EXEC('DROP view IF EXISTS "dbo"."hash__cmis_dbo_contractlockstatus__dbt_tmp_temp_view";');
